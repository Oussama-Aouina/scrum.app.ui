...
const EditTask = ({show, onClose, id, editTask }) => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center">
            ...
            <div className="bg-white w-1/3 bg-opacity-80 backdrop-blur-sm rounded-lg p-5 z-10 text-left">
                ...
                <h2 className="text-5xl drop-shadow-lg font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-tl from-pink-500 via-red-500 to-yellow-500">Edit task</h2>
                <p className='text-xs text-green-800'>Please ensure the information is conveyed with utmost precision and accuracy.</p>
                ...
                <div class="w-full h-32 border rounded-lg overflow-hidden ">
                    <textarea
                        ...
                        onChange={(e) => handlechange(e)}
                        required
                        className="w-full h-full resize-none py-2 px-4 outline-none overflow-y-scroll text-gray-700 leading-tight focus:outline-none text-xs" placeholder="Type or paste your text here..."></textarea>
                </div>
                <label className="block text-gray-600 text-sm font-normal my-2">
                    Deadline
                </label>
